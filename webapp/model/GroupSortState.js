sap.ui.define([
	...
	return BaseObject.extend("dlyRts.DeliveryRoutes.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias dlyRts.DeliveryRoutes.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "Ablad");
			}
