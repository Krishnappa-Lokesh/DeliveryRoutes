sap.ui.define([
	...
	return BaseObject.extend("dlyRts.DeliveryRoutes.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias dlyRts.DeliveryRoutes.model.ListSelector
		 */
		 ...
		 * @return {dlyRts.DeliveryRoutes.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
