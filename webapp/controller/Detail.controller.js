...
sap.ui.define([
	...
	return BaseController.extend("dlyRts.DeliveryRoutes.controller.Detail", {
		...
		onDelete: function () {
			...
			var oViewModel = this.getModel("viewModel"),
				...
				sObjectHeader = this._oODataModel.getProperty(sPath + "/Ablad"),
		...
		_onObjectMatched: function (oEvent) {
			...
			for (var value in oParameter) {
				...
				if (oParameter[value] === "SPACE") {
					oParameter[value] = "";
				}
			}
			this.getModel().metadataLoaded().then(function () {
				var sObjectPath = this.getModel().createKey("dlyRouteSet", oParameter);
		...
		_onBindingChange: function () {
			...
			var sPath = oElementBinding.getBoundContext().getPath(),
				...
				sObjectId = oObject.Ablad,
				sObjectName = oObject.Ablad;
