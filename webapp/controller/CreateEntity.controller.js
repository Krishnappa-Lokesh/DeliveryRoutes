sap.ui.define([
	...
	return BaseController.extend("dlyRts.DeliveryRoutes.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("dlyRouteSet", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("dlyRouteSet", oData);
