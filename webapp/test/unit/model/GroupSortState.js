sap.ui.define([
	"dlyRts/DeliveryRoutes/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("Ablad").length, 1, "The sorting by Ablad returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by Ablad and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("Ablad");
