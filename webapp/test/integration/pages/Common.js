sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("dlyRts/DeliveryRoutes/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#DeliveryRoutes-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#DeliveryRoutes-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("dlyRts.DeliveryRoutes.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["dlyRts/DeliveryRoutes/localService/mockserver"], function (mockserver) {
